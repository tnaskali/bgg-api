...
public class JaxbConfiguration {
  ...
  static class JaxbRuntimeHints implements RuntimeHintsRegistrar {
    ...
    private static final String[] JAXB_REFLECTION_CLASSES = {
      ...
      "java.util.ArrayList",
      "li.naska.bgg.configuration.JacksonConfiguration$JAXBElementMixin",
      "li.naska.bgg.util.DateTimeToZonedDateTimeAdapter",
      "li.naska.bgg.util.IntegerToIntegerAdapter",
      "li.naska.bgg.util.OptionalRfcStringToZonedDateTimeAdapter",
      "li.naska.bgg.util.OptionalStringToDecimalAdapter",
      "li.naska.bgg.util.OptionalStringToIntegerAdapter",
      "li.naska.bgg.util.OptionalStringToLocalDateAdapter",
      "li.naska.bgg.util.RfcStringToZonedDateTimeAdapter",
