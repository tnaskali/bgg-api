...
public class CollectionResource {
  ...
  public Mono<String> getCollectionAsXml(@PathVariable String username,
                                         @Validated BggCollectionV1QueryParams params) {
  ...
  public Mono<String> getCurrentCollectionAsXml(@Validated BggCollectionV1QueryParams params) {
  ...
  public Mono<String> getCurrentCollectionAsJson(@Validated BggCollectionV1QueryParams params) {
