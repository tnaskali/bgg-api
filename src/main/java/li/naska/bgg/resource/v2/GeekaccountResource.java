...
@RestController
@RequestMapping("/api/v2/geekaccount/private")
public class GeekaccountResource {
  ...
  public Mono<BggGeekaccountResponseBody> updateGeekaccount(@ParameterObject @Validated @RequestBody BggGeekaccountRequestBody params) {
