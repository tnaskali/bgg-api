...
import com.boardgamegeek.xml.hot.v2.Items;
...
public class BggHotV2Repository {
  ...
  public Mono<String> getItemsAsJson(BggHotV2QueryParams params) {
    return getItems(params).map(xmlProcessor::toJsonString);
  }

  public Mono<Items> getItems(BggHotV2QueryParams params) {
    return getItemsAsXml(params).map(xml -> xmlProcessor.toJavaObject(xml, Items.class));
  }

  public Mono<String> getItemsAsXml(BggHotV2QueryParams params) {
    return webClient
        .get()
        .uri(uriBuilder ->
