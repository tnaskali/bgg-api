...
public class BggThingV2QueryParams {
  ...
  @Pattern(regexp = "^(bgsleeve|boardgame|boardgameaccessory|boardgameexpansion|rpgissue|rpgitem|videogame|videogamecompilation|videogameexpansion|videogamehardware)(,(bgsleeve|boardgame|boardgameaccessory|boardgameexpansion|rpgissue|rpgitem|videogame|videogamecompilation|videogameexpansion|videogamehardware))*$")
  @Parameter(
