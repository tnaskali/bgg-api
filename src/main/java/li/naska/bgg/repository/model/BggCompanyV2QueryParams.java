...
public class BggCompanyV2QueryParams {
  ...
  @Pattern(regexp = "^(bgsleevemfg|boardgamepublisher|rpgpublisher|videogamedeveloper|videogamehwmfg|videogamepublisher)(,(bgsleevemfg|boardgamepublisher|rpgpublisher|videogamedeveloper|videogamehwmfg|videogamepublisher))*$")
  @Parameter(
