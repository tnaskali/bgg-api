...
public class BggGeekaccountV3Repository {
  ...
  public Mono<BggGeekaccountContactV3ResponseBody> getGeekaccountContact(String cookie, BggGeekaccountContactV3QueryParams params) {
    return webClient
        .get()
        ...
        .map(entity -> {
          ...
          result.setNewstate(doc.getElementById("state").parent().lastElementChild().lastElementChild().attr("value"));
  ...
  public Mono<BggGeekaccountContactV3ResponseBody> updateGeekaccountContact(String cookie, BggGeekaccountContactV3RequestBody body) {
    return webClient
        .post()
        .accept(MediaType.TEXT_HTML)
        .acceptCharset(StandardCharsets.UTF_8)
  ...
  public Mono<BggGeekaccountToplistV3ResponseBody> updateGeekaccountToplist(String cookie, BggGeekaccountToplistV3RequestBody requestBody) {
    return webClient
        .post()
        ...
        .<BggGeekaccountToplistV3ResponseBody>handle((entity, sink) -> {
          try {
            sink.next(objectMapper.readValue(entity.getBody(), BggGeekaccountToplistV3ResponseBody.class));
