  ...
  class Do {
    ...
    class Given_1 {
      ...
      final String mockResponseBody =
          readFileContent("responses/bgg/xmlapi/v1/person/200_NOT_FOUND.xml");
    ...
    class Given_2 {
      ...
      final String mockResponseBody = readFileContent("responses/bgg/xmlapi/v1/person/200_OK.xml");
        ...
        class When_2_1 {
          ...
          class Then {
            ...
            void should_1() {
              verify(
                  1,
                  getRequestedFor(urlEqualTo("/xmlapi/person/2"))
    ...
    class Given_3 {
      ...
      class When {
        ...
        private final Supplier<WebTestClient.ResponseSpec> test = () ->
            Do.this.partialTest.apply(2, new LinkedMultiValueMap<>(), MediaType.APPLICATION_JSON);
        ...
        class Then {
          ...
          void should_3() {
            result
                ...
                .isEqualTo("http://localhost:" + wireMock.port() + "/xmlapi/person/2");
          }
        }
      }
    }
