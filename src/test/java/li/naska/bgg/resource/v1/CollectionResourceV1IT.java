...
public class CollectionResourceV1IT extends AbstractMockServerIT {
  ...
  class Do {
    ...
    class Given_2 {
      ...
      final String mockAcceptedBody =
          readFileContent("responses/bgg/xmlapi/v1/geeklist/202_ACCEPTED.xml");
      final String mockResponseBody =
          readFileContent("responses/bgg/xmlapi/v1/collection/200_OK.xml");
    ...
    class Given_4 {
      ...
      class When {
        ...
        private final Supplier<WebTestClient.ResponseSpec> test = () -> Do.this.partialTest.apply(
            "gandalf", new LinkedMultiValueMap<>(), MediaType.APPLICATION_JSON);
        ...
        class Then {
          ...
          void should_1() {
            verify(
                1,
                getRequestedFor(urlEqualTo("/xmlapi/collection/gandalf"))
                    .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_XML_VALUE))
                    .withHeader(
                        HttpHeaders.ACCEPT_CHARSET,
                        equalTo(StandardCharsets.UTF_8.displayName().toLowerCase())));
          ...
          void should_3() {
            result
                ...
                .isEqualTo("http://localhost:" + wireMock.port() + "/xmlapi/collection/gandalf");
          }
        }
      }
    }
