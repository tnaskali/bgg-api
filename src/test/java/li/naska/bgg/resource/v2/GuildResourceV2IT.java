    ...
    class Given_1 {
      ...
      class When_1 {
        ...
        class Then {
          ...
          void should_2() {
            verify(0, getRequestedFor(urlEqualTo("/xmlapi2/guild")));
          }
        }
      }
      ...
      class When {
        ...
        class Then {
          ...
          void should_1() {
            verify(
                1,
                getRequestedFor(urlEqualTo("/xmlapi2/guild?id=666"))
                    .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_XML_VALUE))
                    .withHeader(
                        HttpHeaders.ACCEPT_CHARSET,
                        equalTo(StandardCharsets.UTF_8.displayName().toLowerCase())));
          ...
          void should_3() {
            result
                ...
                .isEqualTo("http://localhost:" + wireMock.port() + "/xmlapi2/guild?id=666");
          }
        }
      }
    }
