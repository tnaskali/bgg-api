          ...
          class Then {
            ...
            void should_1() {
              verify(
                  1,
                  getRequestedFor(
                          urlEqualTo("/xmlapi2/person?id=22&type=boardgamedesigner&videos=1"))
      ...
      class When {
        ...
        class Then {
          ...
          void should_1() {
            verify(
                1,
                getRequestedFor(urlEqualTo("/xmlapi2/person?id=22"))
                    .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_XML_VALUE))
                    .withHeader(
                        HttpHeaders.ACCEPT_CHARSET,
                        equalTo(StandardCharsets.UTF_8.displayName().toLowerCase())));
          ...
          void should_3() {
            result
                ...
                .isEqualTo("http://localhost:" + wireMock.port() + "/xmlapi2/person?id=22");
          }
        }
      }
    }
