    ...
    class Given_1 {
      ...
      class When_1 {
        ...
        class Then {
          ...
          void should_2() {
            verify(0, getRequestedFor(urlEqualTo("/xmlapi/family")));
          }
        }
      }
      ...
      class When_2 {
        ...
        class When_2_1 {
          ...
          private final Supplier<WebTestClient.ResponseSpec> test =
              () -> Do.Given_1.When_2.this.partialTest.apply(MediaType.APPLICATION_XML);
            ...
            void should_1() {
              verify(
                  ...
                  getRequestedFor(urlEqualTo(
                          "/xmlapi2/family?id=666,667,668&type=boardgamefamily,rpg,rpgperiodical"))
      ...
      class When {
        ...
        class Then {
          ...
          void should_1() {
            verify(
                1,
                getRequestedFor(urlEqualTo("/xmlapi2/family?id=666"))
                    .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_XML_VALUE))
                    .withHeader(
                        HttpHeaders.ACCEPT_CHARSET,
                        equalTo(StandardCharsets.UTF_8.displayName().toLowerCase())));
          ...
          void should_3() {
            result
                ...
                .isEqualTo("http://localhost:" + wireMock.port() + "/xmlapi2/family?id=666");
          }
        }
      }
    }
